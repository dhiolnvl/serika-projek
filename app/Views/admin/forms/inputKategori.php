...
<form action="<?= base_url('/admin/saveKategori') ?>" method="post" enctype="multipart/form-data">
    <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kategori" class="form-control" id="kategori" placeholder="Batik Tulis" required />
                                    </div>
                                </div>
