...
<form action="<?= base_url('/admin/updatePelanggan/' . $user['id_u']) ?>" method="post">
  <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password" c class="form-control" id="password" value="<?= $user['password'] ?>" placeholder="Password" />
                  </div>
                </div>
